        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "کارشناس IT ۱", "userit1234", "IT", "userit1" },
                    { 3, "کارشناس IT ۲", "userit4321", "IT", "userit2" },
                    { 4, "آقای اسدی", "asadi1234", "Employee", "asadi" },
                    { 5, "خانم محمدی", "mohammadi1234", "Employee", "mohammadi" },
                    { 6, "آقای رضایی", "rezaei1234", "Employee", "rezaei" }
                });
